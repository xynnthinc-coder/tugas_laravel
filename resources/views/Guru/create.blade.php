...
@section('page-sub', 'Isi formulir berikut untuk menambahkan guru baru')
...
<div class="max-w-3xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="px-8 py-6 border-b border-gray-100">
            <h3 class="text-xl font-semibold text-slate-900 mb-1">Data Guru Baru</h3>
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('guru.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Ibu Sari Dewi" required
                ...
                <div>
                    ...
                    <input type="text" name="mapel" value="{{ old('mapel') }}" placeholder="Contoh: Matematika, Bahasa Inggris" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                    @error('mapel')
                        <div class="mt-2 flex items-center gap-2 text-sm text-red-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex gap-3 pt-6 border-t border-gray-100">
                    ...
                    <a href="{{ route('guru.index') }}" class="inline-flex items-center px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-medium transition-colors">
                        Batalkan
                    </a>
                </div>
            </form>
