...
<section class="w-full bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-3xl shadow-xl border-gray-100 p-6 overflow-hidden mx-auto">
    <div class="max-w-3xl items-center mx-auto my-10 text-center">
        <h1 class="text-5xl font-bold text-blue-600">Sistem Manajemen Data Siswa</h1>
        <p class="text-lg mt-2 text-gray-600 font-normal">
            Kelola data siswa dengan mudah menggunakan sistem informasi sekolah kami. Tambah, lihat, dan atur informasi siswa serta wali kelasnya dalam satu platform terintegrasi.
        </p>
    </div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl shadow-xl border-gray-100 overflow-hidden">
            ...
            <form method="POST" action="{{ route('siswa.store') }}" class="p-6 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <input name="nama" placeholder="Masukkan nama siswa" required
                ...
                <div class="space-y-2">
                    ...
                    <input name="kelas" placeholder="Contoh: 10A, 11B" required
                        class="border border-gray-300 p-3 w-full rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    @error('kelas')
                        <p class="text-red-500 text-xs">{{ $message }}</p>
                    @enderror
        ...
        <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl shadow-xl border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-3 max-h-[600px] overflow-y-auto">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <form method="POST" action="{{ route('siswa.destroy', $siswa->id) }}" 
                                  onsubmit="return confirm('Yakin ingin menghapus data {{ $siswa->nama }}?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-sm text-gray-400">Tambahkan siswa baru menggunakan form di samping</p>
                </div>
                @endforelse
            </div>
        </div>
